...
def match_1(match_file,output_file,match_line,match_number,match_source,match_destination): 
	...
	if match_Obj_1 != None : 
		...
		match_Obj_2 = re.sub(r'-',"_",match_Obj_1.group(1)) + "_" + match_Obj_2
		with open(match_file,"a",encoding="UTF-8") as file : 
	...
	if match_Obj_1 != None : 
		match_source = re.sub(r'-',"_",match_Obj_1.group(2))
		match_destination = re.sub(r'-',"_",match_Obj_1.group(3))
		with open(match_file,"a",encoding="UTF-8") as file : 
		...
		if match_Obj_1.group(4) != "Any" :
			...
			with open(match_file,"a",encoding="UTF-8") as file : 
				file.write("source-ip " + match_source + "_" + match_Obj_2 + '\n')
		if match_Obj_1.group(5) != "Any" :
			match_Obj_2 = re.sub(r' ',"_",match_Obj_1.group(5))
			with open(match_file,"a",encoding="UTF-8") as file : 
				file.write("destination-ip " + match_destination + "_" + match_Obj_2 + '\n')
	...
	if match_Obj_1 != None : 
		with open(match_file,"a",encoding="UTF-8") as file : 
			file.write("source-ip " + match_source + "_" + match_Obj_1.group(1) + '\n') 
		return match_source,match_destination
	match_Obj_1=re.match(r'^set dst-address "(.*)" .*$',match_line,re.I) 
	if match_Obj_1 != None : 
		with open(match_file,"a",encoding="UTF-8") as file : 
			file.write("destination-ip " + match_destination + "_" + match_Obj_1.group(1) + '\n') 
		return match_source,match_destination
	...
	if match_Obj_1 != None : 
		...
		return match_source,match_destination
	match_Obj_1=re.match(r'^set policy id (.*) (.*) .*$',match_line,re.I) 
	if match_Obj_1 != None : 
		if match_Obj_1.group(2) == "disable" : 
			with open(match_file,"a",encoding="UTF-8") as file : 
