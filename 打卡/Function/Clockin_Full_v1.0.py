...
with open('./log/clockin_log.log',"a",encoding="UTF-8") as file : 
    file.write('\n' + time.asctime(time.localtime(time.time())) + " && " + "Clockin_Full_v1.0.py" + " && " + "脚本开始运行") 
...
with open('./log/clockin_log.log',"a",encoding="UTF-8") as file : 
    file.write('\n' + time.asctime(time.localtime(time.time())) + " && " + "Clockin_Full_v1.0.py" + " && " + "脚本生成打卡时间") 
...
while True :
    ...
    if match_check == 0 :
        if match_nowtime == "07:" + match_minute or match_nowtime == "19:" + match_minute :
            ...
            with open('./log/clockin_log.log',"a",encoding="UTF-8") as file : 
                file.write('\n' + time.asctime(time.localtime(time.time())) + " && " + "Clockin_Full_v1.0.py" + " && " + "脚本开始打卡") 
