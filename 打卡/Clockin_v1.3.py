...
clockin_location['183'] = "114.409015,30.462988"
clockin_location['184'] = "114.090615,30.315705"
clockin_location['185'] = "114.257618,30.719646"
clockin_location['186'] = "114.324857,30.558988"
clockin_location['187'] = "114.346933,30.557609"
clockin_location['188'] = "114.406382,30.643831"
clockin_location['189'] = "114.045852,30.581356"
clockin_location['190'] = "114.359666,30.615591"
clockin_location['191'] = "114.392033,30.884089"
clockin_location['192'] = "114.417605,30.489586"
clockin_location['193'] = "114.134002,30.622731"
clockin_location['194'] = "114.254227,30.590873"
clockin_location['195'] = "114.247215,30.739189"
clockin_location['196'] = "114.367627,30.624587"
clockin_location['197'] = "114.426369,30.466004"
clockin_location['198'] = "114.520408,30.528889"
clockin_location['199'] = "114.406565,30.643877"
clockin_location['200'] = "114.277861,30.586139"
clockin_location['201'] = "114.116981,30.555827"
clockin_location['202'] = "114.181359,30.513802"
clockin_location['203'] = "114.283275,30.602181"
clockin_location['204'] = "114.287416,30.585783"


while True :
    match_nowtime = time.asctime(time.localtime(time.time()))[11:16]
    if match_nowtime == "08:00" or match_nowtime == "20:00" :
        clockin_number_id = str(random.randint(100,204))
        clockin_cli = "ldconsole.exe action --index 0 --key call.locate --value " + clockin_location[clockin_number_id]
        clockin_log = subprocess.getstatusoutput(clockin_cli)
        if clockin_log[0] == 0 :
            print ("位置已更新,更新时间为 " + time.asctime(time.localtime(time.time())) + ",等待下次更新")
        time.sleep(100)
    time.sleep(10)